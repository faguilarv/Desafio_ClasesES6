...
var Cliente = exports.Cliente = /*#__PURE__*/function () {
  ...
  _createClass(Cliente, [{
    ...
    set: function set(valor) {
      _classPrivateFieldSet(_impuesto, this, valor);
    }
  }, {
    key: "setNombre",
    set: function set(valor) {
      if (typeof valor === "string") {
        _classPrivateFieldSet(_nombre, this, valor);
      } else {
    ...
    key: "calcularMontoNetoAnual",
    value: function calcularMontoNetoAnual() {
      return (_classPrivateFieldGet(_impuesto, this).montoBrutoAnual - _classPrivateFieldGet(_impuesto, this).deducibles) * 0.21;
    }
  }]);
  return Cliente;
}();